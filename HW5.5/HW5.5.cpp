...
int main() {
	...
	while (true) {
		...
		else if (symbol == '+' || symbol == '-' || symbol == ',' || symbol == ';' || symbol == ':' || symbol == '*' || symbol == '/' || symbol == '^' || symbol == '$' || symbol == '%' || symbol == '!' || symbol == '@' || symbol == '#' || symbol == '&' || symbol == '(' || symbol == ')' || symbol == '[' || symbol == ']' || symbol == '{' || symbol == '}' || symbol == '?')
		{
